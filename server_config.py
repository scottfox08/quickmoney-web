...
<script>
    ...
    class Particle {
        constructor() {
            ...
            this.speedY = Math.random() * 0.6 - 0.3; this.color = Math.random() > 0.1 ? '#c5a059' : '#fff';
        }
        update() {
...
def panel():
    ...
    <div class="container">
            ...
            <div>
                {f'''<div class="card" style="border:1px solid var(--gold)"><span class="card-h">👑 ADMIN NITRO CONTROL</span>
                    ...
                    <form action="/admin_add_saldo" method="POST" class="flex-row">
                        ...
                        <input name="amount" type="number" step="0.01" placeholder="$" style="margin-bottom:0; width:60px;">
        ...
        <div style="text-align:center; margin:30px 0; font-size:10px;">
            ...
            <a href="/logout" style="color:#666">CERRAR SESIÓN</a>
        </div>
    </div>
    {JS_SCRIPT}
    </body></html>
